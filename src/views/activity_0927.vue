  ...
  export default {
    ...
    methods: {
      ...
      handleScroll() {
        ...
        sessionStorage.setItem("act0927", scrollTop);
      },
      //分享网页
      shareUrl() {
    ...
    activated() {
      ...
      if (!this.$route.meta.isBack) {
        ...
        this.$refs.bodyhtml.scrollTop = sessionStorage.getItem("act0927");
      }
    },
  };
...
<style scoped>
  ...
  .header {
    width: 100%;
    height: 7.29rem;
    background: url('https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/180927/header.png') no-repeat top center/100%;
  }

  ul.actList {
    padding: 0 0.22rem;
    margin-top: 0.6rem;
    background:linear-gradient(180deg,rgba(111,134,152,0.11) 0%,rgba(111,134,152,1) 100%);
  }
