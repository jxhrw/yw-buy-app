  ...
  export default {
    ...
    methods: {
      ...
      handleScroll() {
        ...
        sessionStorage.setItem("act0929", scrollTop);
      },
      //分享网页
      shareUrl() {
    ...
    activated() {
      ...
      if (!this.$route.meta.isBack) {
        ...
        this.$refs.bodyhtml.scrollTop = sessionStorage.getItem("act0929");
      }
    },
  };
...
<style scoped>
  ...
  .header {
    width: 100%;
    height: 7.73rem;
    background: url('https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/180929/header.png') no-repeat top center/100%;
  }
